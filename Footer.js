  ...
  return (
    ...
    <div className='footer-container'>
     <section className='footer-subscription'>
            ...
            {/* <form>
                    <input type="email" name="e-mail" placeholder="Your email" className="footer-input"/>
                    <Button buttonSize='btn--outline'>Take a look</Button>
                </form> this is to input your email */}
            </div>
         </section>
